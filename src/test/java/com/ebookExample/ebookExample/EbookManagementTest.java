...
public class EbookManagementTest {
	...
	public void testUpdateRequestStatus() throws DoesNotExistsException {
		...
		try {
			...
			assertEquals(status, ebookManagement.getRequestStatus()); // Assert that the request status is updated correctly
			...
			assertNotSame(RequestStatus.PENDING, ebookManagement.getRequestStatus()); // Assert that the request status is not equal to PENDING
